...
GLM = $(LIBINCLUDEDIR)$(GLMDIR)
STB = $(LIBINCLUDEDIR)$(STBDIR)
...
.SECONDARY: $(OBJS) $(TESTOBJS) $(SAMPLESOBJS)
...
$(GLM): $(LIBSRCDIR)$(GLMDIR) | $(LIBINCLUDEDIR)
	$(CP) $(LIBSRCDIR)$(GLMDIR)glm $(LIBINCLUDEDIR)$(GLMDIR)

$(STB): $(LIBSRCDIR)$(STBDIR) | $(LIBINCLUDEDIR)
	$(CP) $(LIBSRCDIR)$(STBDIR) $(LIBINCLUDEDIR)$(STBDIR)
